...
\pause
\item Das Adjunkt muß gesättigt sein ({\sc subcat} \liste{}):
        \eal
        \ex[]{
...
\rput[B](7,-2){\rnode{hars}{\it head"=argument-phrase}}
...
\rnode{2}{AP[\begin{tabular}[t]{@{}l}
  ...
  \end{tabular}} & \rnode{3}{\ibox{4} \nbar[\begin{tabular}[t]{@{}l}
                                       ...
                                       {\sc subcat} \rnode{sc2}{\ibox{2}} \sliste{ det },\\
