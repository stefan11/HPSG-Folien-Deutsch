...
%
\rput[B](1,1){\rnode{speccp}{\blau<1>{diesen Mann}}}
...
%
\rput[B](1,9){\rnode{np3}{\blau<1>{NP$_i$}}}
...
\item Knoten in der Mitte einer Fernabhängigkeit können darauf zugreifen\\
      ...
      \hphantom{(}Kikuyu, Ewe, Thompson Salish, Moore, Französisch, Spanisch, Jiddisch)
\end{itemize}
...
\ms[nonloc]{
 ...
 \visible<3->{slash & \type{list~of~local~structures}} \\ %\\
 %extra & \ms[list~of~local~structrues]{} \\
}
\medskip
