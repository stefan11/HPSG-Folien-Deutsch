...
\scalebox{0.73}{\ms{ phon & list~of~phoneme strings\\
...
\visible<2->{\scalebox{0.73}{\ms{ phon & list~of~phoneme strings\\
...
\ms{
      synsem & \onems{ loc$|$cat$|$subcat {\rm del(\ibox{1},\ibox{2})}\\
                     }\\
      head-dtr & \onems{ synsem$|$loc$|$cat$|$subcat \ibox{2} \\
                       }\\
      non-head-dtrs & \sliste{\onems{ synsem \ibox{1}  \\ }}
}
