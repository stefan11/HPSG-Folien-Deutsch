...
\newtoggle{backup}\togglefalse{backup}
%% \provideboolean{handout}\setboolean{handout}{true}

%\includeonly{hpsg-light}

%\includeonly{hpsg-organisatorisches,hpsg-einleitung,hpsg-light,hpsg-formalismus,hpsg-valenz-grammatikregeln,hpsg-komplementation,hpsg-semantik,hpsg-adjunktion-spezifikation,hpsg-lexikon,hpsg-topologie,hpsg-konstituentenreihenfolge,hpsg-nla,lokalitaet-hpsg-folien}
